This project uses the K-Nearest Neighbors (KNN) algorithm to predict stock prices. It consists of both classification and regression tasks, trained on the TATAGLOBAL dataset.
